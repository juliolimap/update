...
list.slots[0].set_pos(flx*0.074, fly*0.155, flw*0.330, flh*0.044);
...
list.slots[1].set_pos(flx*0.074, fly*0.215, flw*0.330, flh*0.080);
...
list.slots[2].set_pos(flx*0.074, fly*0.285, flw*0.330, flh*0.080);
...
list.slots[3].set_pos(flx*0.074, fly*0.355, flw*0.330, flh*0.080);
...
list.slots[4].set_pos(flx*0.074, fly*0.425, flw*0.330, flh*0.080);
...
list.slots[5].set_pos(flx*0.074, fly*0.498, flw*0.330, flh*0.080);
...
list.slots[6].set_pos(flx*0.074, fly*0.572, flw*0.330, flh*0.080);
...
list.slots[7].set_pos(flx*0.074, fly*0.643, flw*0.330, flh*0.080);
...
list.slots[8].set_pos(flx*0.074, fly*0.715, flw*0.330, flh*0.080);
...
list.slots[9].set_pos(flx*0.074, fly*0.780, flw*0.330, flh*0.080);
