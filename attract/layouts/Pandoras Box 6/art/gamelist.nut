...
local scroller10 = ScrollingText.add( "[Title]", flx*0.098, fly*0.875, flw*0.430 - flh*0.080, 70, ScrollType.HORIZONTAL_LEFT );
    ...
    scroller10.set_rgb( 200, 200, 200 );
