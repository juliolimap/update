...
local pow = ShufflePow(10, "image", "Barra 1.png");
...
class Shuffle extends Shuffle {
	...
	function deselect(slot) {
		...
		slot.set_rgb (250,250,250);
		 
	}
}

//===================================================================================
local list = Shuffle(10, "text", "[ListEntry]  [Title]");
